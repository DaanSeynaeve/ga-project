        ...
        for i=1:size(OldChrom,2)
            ...
            if index_i_parent1 == 1
                if index_i_parent2 == 1
                    edge_table.(field) = [parent1(length(parent1)), ...
                        parent1(2), parent2(length(parent2)) parent2(2)];
                elseif index_i_parent2 == length(parent2)
                    edge_table.(field) = [parent1(length(parent1)), ...
                        parent1(2), parent2(index_i_parent2-1) parent2(1)];
                else
                    edge_table.(field) = [parent1(length(parent1)), ...
                        parent1(2), parent2(index_i_parent2-1) parent2(index_i_parent2+1)];
                end
            elseif index_i_parent1 == length(parent1)
                if index_i_parent2 == 1
                    edge_table.(field) = [parent1(index_i_parent1-1), ...
                        parent1(1), parent2(length(parent2)) parent2(2)];
                elseif index_i_parent2 == length(parent2)
                    edge_table.(field) = [parent1(index_i_parent1-1), ...
                        parent1(1), parent2(index_i_parent2-1) parent2(1)];
                else
                    edge_table.(field) = [parent1(index_i_parent1-1), ...
                        parent1(1), parent2(index_i_parent2-1) parent2(index_i_parent2+1)];
                end
            else
                if index_i_parent2 == 1
                    edge_table.(field) = [parent1(index_i_parent1-1), ...
                        parent1(index_i_parent1+1), parent2(length(parent2)) parent2(2)];
                elseif index_i_parent2 == length(parent2)
                    edge_table.(field) = [parent1(index_i_parent1-1), ...
                        parent1(index_i_parent1+1), parent2(index_i_parent2-1) parent2(1)];
                else
                    edge_table.(field) = [parent1(index_i_parent1-1), ...
                        parent1(index_i_parent1+1), parent2(index_i_parent2-1) parent2(index_i_parent2+1)];
                end
            end
        end
        %% crossover operation
