...
crossover = uicontrol(ph,'Style','popupmenu', 'String',{'scx','edge_cross','partially_mapped_cross','order_cross','cycle_cross'}, 'Value',1,'Position',[10 50 130 20],'Callback',@crossover_Callback);
mutation = uicontrol(ph,'Style','popupmenu', 'String',{'scramble','insert','swap','inversion'}, 'Value',1,'Position',[150 50 130 20],'Callback',@mutation_Callback);
